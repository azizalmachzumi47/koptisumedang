<div class="col-md-12">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Form Add Kacang</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <?php
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Harga</label>
                        <input name="harga" class="form-control" placeholder="Harga Kacang"
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" class="form-control" rows="5"
                    placeholder="Deskripsi Kacang"><?= set_value('deskripsi') ?></textarea>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <img src="<?= base_url('assets/gambar/no_foto.png') ?>" id="gambar_load" width="300px">
                    </div>
                </div>
            </div>

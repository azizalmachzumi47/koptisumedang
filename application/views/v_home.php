        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <?php
                    ...
                    echo form_hidden('id', $value->id_kacang);
                    echo form_hidden('qty', 1);
                    echo form_hidden('price', $value->harga);
                    echo form_hidden('name', $value->nama_kacang);
                    echo form_hidden('redirect_page', str_replace('index.php/', '', current_url()));
                    ?>

                <div class="card bg-light">
                    <div class="card-header text-muted border-bottom-0">
                        <h2 class="lead"><b><?= $value->nama_kacang ?></b></h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="text-right">
                                    <a href="<?= base_url('home/detail_kacang/' . $value->id_kacang) ?>"

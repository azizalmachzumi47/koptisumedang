    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered" id="example1">
                ...
                <tbody>
                    <?php $no = 1;
                    foreach ($gambarkacang as $key => $value) { ?>
                    <tr>
                        <td><?= $no++; ?></td>
                        <td><?= $value->nama_kacang ?></td>
                        ...
                        <td class="text-center">
                            <a href="<?= base_url('gambarkacang/add/' . $value->id_kacang) ?>"
                                class="btn btn-success btn-sm"><i class="fas fa-plus"></i>Add Gambar</a>
                        </td>
                    </tr>
                    <?php } ?>

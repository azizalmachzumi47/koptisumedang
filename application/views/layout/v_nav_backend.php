...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<?= base_url() ?>assets/foto/user.png" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    ...
                    <?php if ($this->uri->segment(1) == 'admin' and $this->uri->segment(1) == "") {
                        echo "active";
                    } ?>">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('kacang') ?>" class="nav-link 
                    <?php if ($this->uri->segment(1) == 'kacang') {
                        echo "active";
                    } ?>">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('gambarkacang') ?>" class="nav-link 
                    <?php if ($this->uri->segment(1) == 'gambarkacang') {
                        echo "active";
                    } ?>">

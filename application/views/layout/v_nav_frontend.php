...
<nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
        <a href="<?= base_url() ?>" class="navbar-brand">
            ...
            <span class="brand-text font-weight-light">Kopti Sumedang</span>
        </a>
            ...
            <li class="nav-item">
                <?php if ($this->session->userdata('email') == "") { ?>
                    <a class="nav-link" href="<?= base_url('pelanggan/login') ?>">
                        ...
                        <img src="<?= base_url() ?>assets/foto/user.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                    </a>
                <?php } else { ?>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <?php if (empty($keranjang)) { ?>
                        ...
                        <?php } else {
                        foreach ($keranjang as $key => $value) {
                            $kacang = $this->m_home->detail_kacang($value['id']);
                        ?>
                            <a href="#" class="dropdown-item">
                                <div class="media">
                                    <img src="<?= base_url('assets/gambar/' . $kacang->gambar) ?>" alt="User Avatar" class="img-size-50 mr-3">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Kopti Sumedang</a></li>

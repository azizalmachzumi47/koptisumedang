            ...
            <div class="col-sm-12">
                ...
                <table class="table" cellpadding="6" cellspacing="1" style="width:100%">
                    ...
                    foreach ($this->cart->contents() as $items) {
                        $kacang = $this->m_home->detail_kacang($items['id']);
                        $berat = $items['qty'] * $kacang->berat;
                        // $berat_satuan = $kacang->berat_satuan;
                        // $kacang->berat_satuan;
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?= $berat ?> <!-- <?= $berat_satuan ?> --></td>
                    ...
                    <tr>
                        ...
                        <td class="right">
                            <h3>
                                Rp. <?php echo number_format($this->cart->total(), 0); ?></h3>
                        </td>
